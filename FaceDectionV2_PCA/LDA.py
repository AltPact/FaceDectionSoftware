...
def read_images():
    ...
    #                 if i < required_no:
    #                     imgPathTraining += [img_path]
    #                     labelsTraining += [per_no]
    #                     # Check to see if this person img is already in the self so no duplicants
    #                     if len(NumImagesTraining) > per_no:
    #                         # add 1 more to training
    #                         NumImagesTraining[per_no] += 1
    #                     else:
    #                         NumImagesTraining += [1]
                        
    #                     if i == 0:
    #                         imagesTargetArray += [name]
    #                         imagesTargetSet[per_no] = name
                        
    #                 else:
    #                     imgPathTesting += [img_path]
    #                     labelsTesting += [per_no]

    #                     if len(NumImagesTesting) > per_no:
    #                         NumImagesTesting[per_no] += 1
    #                     else:
    #                         NumImagesTesting += [1]
    #                 i += 1
    #             per_no += 1
    ...
    for name in os.listdir(dir):
        folderPath = os.path.join(dir,name)
...
if  __name__ == '__main__':
    ...
    # train_data,train_labels,test_data,test_labels = read_images()
